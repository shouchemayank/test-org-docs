...
## Setup your local dév environment

Learn how to update your docs lōcally and and deploy them to the public.
Some text being added here through the GH ui.
...
<Card
  title="Card Title To Ingest"
  icon="browser"
  href="/settings/custom-domain/subdomain"
>
  The title of this card should show up in search indexing.
</Card>
</CardGroup>
